...
export default function IdentityCard({ category }: { category: BudgetCategory }) {
	...
	return (
		<div className="flex w-auto shrink-0 flex-col gap-3 rounded-3xl bg-white p-4 shadow-[0_8px_20px_-12px_rgba(15,23,41,0.25)]">
			<div className="flex items-center justify-between">
				...
				>
					<User size={16} style={{ color: category.color }} strokeWidth={2.2} />
				</span>
			...
			<div className="flex flex-col items-start justify-between">
				...
				<p className="mt-0.5 text-[11px] font-bold text-gray-900/70">
					Voter Id: <span className="text-gray-900 px-3">{category.budget.toLocaleString()}</span>
				</p>
			</div>
